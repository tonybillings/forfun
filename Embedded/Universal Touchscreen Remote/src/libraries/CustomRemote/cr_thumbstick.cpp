...
CRThumbstick::CRThumbstick(int16_t pinX, int16_t pinY, int16_t pinEnter, ThumbstickMode mode) : IsPressed(false), Tag(0)
{
    Initialize(pinX, pinY, pinEnter, mode);
}

CRThumbstick::~CRThumbstick () {}

void CRThumbstick::Initialize(int16_t pinX, int16_t pinY, int16_t pinEnter, ThumbstickMode mode)
{
    m_pinX = pinX;
    m_pinY = pinY;
    m_pinEnter = pinEnter;
...
ThumbstickState CRThumbstick::GetState()
{
    return m_state;
}

bool CRThumbstick::Update()
{
...
void CRThumbstick::SetMode(ThumbstickMode mode)
{
    m_mode = mode;
}