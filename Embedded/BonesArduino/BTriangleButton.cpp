...
BTriangleButton::BTriangleButton(TFT_TYPE_PTR tft)
{
    Initialize(tft);
	m_isPressed = false;
}

BTriangleButton::BTriangleButton(const BTriangleButton& other)
{
    m_tft = other.m_tft;
	m_isPressed = false;
...
void BTriangleButton::Initialize(TFT_TYPE_PTR tft)
{
    m_tft = tft;
}

void BTriangleButton::Draw()
{
