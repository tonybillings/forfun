...
__inline static void packet_store_header(unsigned char *dst, int section, int subsection)
{
   LTC_ARGCHK(dst != NULL);
...
static __inline int packet_valid_header (unsigned char *src, int section, int subsection)
{
   unsigned long ver;
